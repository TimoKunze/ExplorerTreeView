...
protected:
	...
	struct Controls
	{
		...
		/// \brief <em>Wraps the listview displaying the values for the \c ItemBoundingBoxDefinition property</em>
		CCheckListViewCtrl itemBoundingBoxList;
		/// \brief <em>Wraps the listview displaying the values for the \c BuiltInStateImages property</em>
		CCheckListViewCtrl builtInStateImagesList;
